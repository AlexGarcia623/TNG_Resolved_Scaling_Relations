...
plt.hist2d(all_gm  , all_sfr, bins=(75,75), cmap=cmr.get_sub_cmap('Greys', 0, 0.8), 
           rasterized=True, norm='log', alpha=0.5, zorder=2)

mass, sfr, sfr1, sfr2 = median(all_gm, all_sfr)
...
for k in range(len(titles)):
    ...
    mass, sfr, sfr1, sfr2 = median(all_gm[within_dm], all_sfr[within_dm])
...
plt.tight_layout()
plt.savefig('./figs/Figure8.pdf', bbox_inches='tight')